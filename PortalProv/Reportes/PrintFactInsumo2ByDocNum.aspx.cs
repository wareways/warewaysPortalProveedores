...
{
    public partial class PrintFactInsumo2ByDocNum : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var ArchivoReporte = HttpContext.Current.Server.MapPath("~/Reportes/Fact_v1Insumos.rpt");
            var _Id = "";
            ...
            if (_Id != null)
            {
                ...
                using (System.IO.FileStream MyFileStream = new System.IO.FileStream(Nombretemp, System.IO.FileMode.Create))
                {
                    ...
                    foreach (string idEM in _Id.Split(','))
                    {
                        ...
                        var _SAP_companydb = ConfigurationManager.AppSettings["CompanyDbInsumos"];
                        ...
                        var ReportData = vService.List_SapInsumoFactByDocnum(_Id.ToString(), _SAP_companydb);
