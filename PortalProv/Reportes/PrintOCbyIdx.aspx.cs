...
{
    public partial class PrintOCByIdx : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var _doc = "";
            try { _doc = Page.Request.QueryString["doc"].ToString(); } catch { Response.End(); }
            ...
            if (_Id != null)
            {
                ...
                var ReportData2 = vService.List_SapOPORByDocnum(_Id.Split(',')[0]);

                var Nombretemp = HttpContext.Current.Server.MapPath("~/Cargados/"  + _doc);
                using (System.IO.FileStream MyFileStream = new System.IO.FileStream(Nombretemp, System.IO.FileMode.Create))
                {
                    ...
                    {
                        var ReportData = vService.List_SapOPORByDocnum(idEM);
